...
public class BreadBowlPropsUtils {
    ...
    public static Item.Properties ItemProps(FoodProperties food, CreativeModeTab tab) {
        return new Item.Properties()
                .food(food)
                .stacksTo(16)
                .tab(tab);
    ...
    public static Item.Properties ItemAndFoodProps(FoodProperties food, CreativeModeTab tab) {
        return ItemProps(FoodProps(food), tab);
    }
}
